import { motion } from "framer-motion"; // 1. زيد الـ Import هذا باش يتنحى الخط الأحمر

const Step3 = ({ next, back, data, setData }) => {
  const times = ["8:00 AM", "9:00 AM", "10:00 AM", "11:00 AM", "12:00 PM", "1:00 PM", "2:00 PM", "3:00 PM", "4:00 PM", "5:00 PM"];
  
  // مثال لأيام الأسبوع (تنجم تزيدهم بـ Map أوتوماتيك)
  const days = [
    ...
    >
      <div className="space-y-8">
        ...
        <div className="flex justify-between mt-12">
          ...
          <button
            onClick={next}
            disabled={!data.date || !data.time} // 2. التثبيت الصحيح
